...
public class SignInWhileCheckOut {
		
	WebDriver driver;
		
		public SignInWhileCheckOut(WebDriver idriver) {
			driver = idriver;
		...
		//View product and Add to cart - with Size, Color, Quantity
			...
			public void placeorder() throws InterruptedException {
				...
				//Sign In before placing order
				driver.findElement(By.xpath("//button[@class='action action-auth-toggle']/span")).click();
				driver.findElement(By.id("login-email")).sendKeys("likhitha1@gmail.com");
				driver.findElement(By.id("login-password")).sendKeys("Likith@123");
				driver.findElement(By.xpath("//form[@data-role='login']//button[@type='submit']")).click();
				Thread.sleep(5000);

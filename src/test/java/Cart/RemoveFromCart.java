...
WebDriver driver;
	...
	//View product and Add to cart - with Size, Color, Quantity
		...
		public void removeCart() throws InterruptedException {
			...
			//To display message: You have no items in your shopping cart.
			
			String msg = driver.findElement(By.xpath("//div[@class='cart-empty']")).getText();
			System.out.println(msg);
			Thread.sleep(2000);
			
		}
		
		//To click on here link to continue with shipping
